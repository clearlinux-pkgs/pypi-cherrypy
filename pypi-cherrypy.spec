...
Source0  : https://files.pythonhosted.org/packages/bd/5f/e265a49883bfcfb7f2c3d3d9e96197cfe8136783e96c5ce20e201550aaa0/CherryPy-18.9.0.tar.gz
...
%prep
%setup -q -n CherryPy-18.9.0
cd %{_builddir}/CherryPy-18.9.0
pushd ..
cp -a CherryPy-18.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702496244
