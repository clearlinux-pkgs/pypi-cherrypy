...
Source0  : https://files.pythonhosted.org/packages/93/e8/2f7ef142d1962d08a8885c4c9942212abecad6a80ccdd1620fd1f5c993fd/cherrypy-18.10.0.tar.gz
...
%prep
%setup -q -n cherrypy-18.10.0
cd %{_builddir}/cherrypy-18.10.0
pushd ..
cp -a cherrypy-18.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718603599
...
cp %{_builddir}/cherrypy-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-cherrypy/57a276aabf6e4c65ba334b8b92a08f95620517fc || :
